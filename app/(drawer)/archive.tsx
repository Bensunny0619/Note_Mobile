    ...
    return (
        <SafeAreaView style={[styles.container, isDarkMode && styles.containerDark]}>
            <View style={styles.header}>
                <Text style={[styles.headerTitle, isDarkMode && styles.textDark]}>Archive</Text>
            ...
            {notes.length === 0 ? (
                <View style={styles.emptyContainer}>
                    <Feather name="archive" size={64} color={isDarkMode ? "#94a3b8" : "#cbd5e1"} />
                    <Text style={[styles.emptyTitle, isDarkMode && styles.textDark]}>No Archived Notes</Text>
